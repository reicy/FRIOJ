...
@Service
public class JavaSourceCodePreprocessor implements SourceCodePreprocessor{

	private String[][] forbiddenLibraries = {};
	private String[][] forbiddenExpressions = 
		{
			{"implements[\\s]+Runnable","Thread (impl runnable version)"},
			{"extends[\\s]+Thread","Thread (extends thread version)"}
		};
